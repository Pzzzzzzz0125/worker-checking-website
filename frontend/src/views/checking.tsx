...
type SiteSort = "name_asc" | "name_desc" | "cost_desc" | "cost_asc" | "hours_desc" | "hours_asc" | "days_desc" | "days_asc" | "first_desc" | "first_asc" | "last_desc" | "last_asc"
    ...
    {data&&<>
      ...
      <Card>
        ...
        <CardContent><div className="table-wrap"><table className="data-table">
          <thead><tr><SortableHeader label="Worker" active={sort.startsWith("name_")} direction={sort.endsWith("_asc")?"asc":"desc"} onClick={()=>changeSort("name","asc")}/><th>Type</th><SortableHeader label="Hours" active={sort.startsWith("hours_")} direction={sort.endsWith("_asc")?"asc":"desc"} onClick={()=>changeSort("hours","desc")}/><SortableHeader label="Estimated cost" active={sort.startsWith("cost_")} direction={sort.endsWith("_asc")?"asc":"desc"} onClick={()=>changeSort("cost","desc")}/><SortableHeader label="Days" active={sort.startsWith("days_")} direction={sort.endsWith("_asc")?"asc":"desc"} onClick={()=>changeSort("days","desc")}/><SortableHeader label="First day" active={sort.startsWith("first_")} direction={sort.endsWith("_asc")?"asc":"desc"} onClick={()=>changeSort("first","asc")}/><SortableHeader label="Last day" active={sort.startsWith("last_")} direction={sort.endsWith("_asc")?"asc":"desc"} onClick={()=>changeSort("last","asc")}/><th></th></tr></thead>
