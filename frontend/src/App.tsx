...
const hashView=():View=>{const raw=location.hash.slice(1);const value=(raw==="transfer"?"import":raw==="locations"?"sites":raw) as View;return ["overview","payroll","sites","ai","daily","worker","workers","import","export"].includes(value)?value:"overview"}
