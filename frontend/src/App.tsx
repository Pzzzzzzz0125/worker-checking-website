...
export default function App(){
 ...
 return <AppShell view={view} setView={setView}>
   ...
   <datalist id="report-locations">{(bootstrap.report_locations||bootstrap.locations).map(x=><option value={x} key={x}/>)}</datalist>
