...
- Archived workers disappear from Overview, Payroll, Locations, AI, Daily
...
| GET | `/api/bootstrap_details` | deferred location metadata |
...
At this handoff, the Python suite contains **59 tests** with one workbook test
